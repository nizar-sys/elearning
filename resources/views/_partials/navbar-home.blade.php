<nav id="navmenu" class="navmenu">
    <ul>
        ...
        <li><a href="{{ route('about') }}" class="{{ setSidebarActive(['about']) }}">Abouts</a></li>
        ...
        <li>
            <a href="#" class="btn btn-transparent text-center btn-search" data-target="#searchModal" data-target="modal">
