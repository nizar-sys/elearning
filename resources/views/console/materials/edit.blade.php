        ...
        <div class="card">
            ...
            <div class="card-header border-bottom">
                <h5 class="card-title mb-0">
                    <span class="fw-normal">Edit Material</span>
                </h5>
            </div>
            ...
            <div class="card-body">
                <div class="offcanvas-body mx-0 flex-grow-0 h-100 mt-2">
                    ...
                    <form class="material pt-0" id="materialForm" method="POST" action="{{ route('materials.update', $material->id) }}"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-floating form-floating-outline mb-5 mt-2">
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        ...
                                        placeholder="Material Title" value="{{ old('title', $material->title) }}" />
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-floating form-floating-outline mb-5 mt-2">
                                    <textarea class="form-control @error('description') is-invalid @enderror full-editor" id="material-description"
                                        name="description" aria-label="Description" placeholder="Description" cols="30" rows="10">{{ old('description', $material->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
...
@push('scripts')
    <script>
        var existingFiles = @json($material->thumbnail);
    </script>
    @vite('resources/js/console/materials/edit_validation_script.js')
@endpush
