        ...
        <div class="card">
            ...
            <div class="card-header border-bottom">
                <h5 class="card-title mb-0">
                    <span class="fw-normal">Add Benefit</span>
                </h5>
            </div>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-floating form-floating-outline mb-5 mt-2">
                                    <input type="text" class="form-control @error('type') is-invalid @enderror"
                                        ...
                                        aria-label="Benefit Type" value="{{ old('type') }}" />
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <div class="form-floating form-floating-outline mb-5 mt-2">
                                    <textarea class="form-control @error('description') is-invalid @enderror full-editor" id="benefit-description"
                                        placeholder="Benefit Description" name="description" aria-label="Benefit Description" cols="30" rows="10">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
